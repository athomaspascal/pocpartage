...
(
  ID            INTEGER default (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_26334689_3E12_4D1C_9AA6_57161FCEC292) auto_increment
    primary key,
...
(
  ID                 INTEGER default (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_2FFFA502_F23C_4770_B251_49DF2CEC7FF4) auto_increment
    primary key,
...
(
  ID             INTEGER default (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_9A2A1EFA_55DD_4489_B456_7FE730570148) auto_increment
    primary key,
...
(
  ID                       INTEGER default (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_B906C4FC_EC95_4E45_87A4_3FFC664E0A08) auto_increment
    primary key,
...
(
  ID          INTEGER default (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_7491F9FB_8FB5_4A12_B415_D2FD8A45AB09) auto_increment
    primary key,
...
(
  ID    BIGINT default (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_1B846486_55E2_4BF0_94CA_BD5B7E8698F8) auto_increment
    primary key,
  ADMIN BOOLEAN,
  NAME  VARCHAR(255)
);
...
(
  ID          INTEGER default (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_93A175C7_16EA_4C29_A768_1B70A48E4985) auto_increment
    primary key,
  SERVER_NAME VARCHAR(50)
    constraint SERVERS_SERVER_NAME_UINDEX
      unique,
  SERVER_IP   VARCHAR(20)
    constraint SERVERS_SERVER_IP_UINDEX
      unique
);

create table SHARE_SPACE
(
  ID               INTEGER default (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_575D7426_D116_4F53_80D4_AB612B718663) auto_increment
    primary key,
...
(
  ...
  ID              BIGINT default (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_B03472B2_B227_4849_B30B_7B86CDF7DBC3) auto_increment
    primary key,
...
(
  ID            BIGINT default (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_15CA1E19_B9FE_4248_A2F7_E5CFFD02B9C4) auto_increment
    primary key,
  NAME          VARCHAR(50),
...
(
  ID            INTEGER default (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_377E63E1_CC52_4650_A32C_D410463D5369) auto_increment
    primary key,
  DATE_CREATION DATE,
  TEAM_ID       INTEGER,
...
(
  ID          INTEGER default (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_2B538E9D_9C66_4F23_8157_89BBC19D1458) auto_increment
    primary key,
  ID_QUESTION INTEGER,
...
create table USER
(
  ID             BIGINT default (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_1879A31A_9A7D_466C_A76C_4929CE3F1974) auto_increment
    primary key,
...
(
  ID      INTEGER default (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_BBE1C301_D11A_400A_8BE0_338DE79E31E5) auto_increment
    primary key,
  TEAM_ID BIGINT,
  USER_ID INTEGER,
